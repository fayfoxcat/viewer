...
/**
 * Viewer文件查看器安全配置类 - Spring Security 适配
 * <p>
...
public class ViewerSecurityConfig {
    ...
    public ViewerSecurityConfig(ViewerProperties properties) {
        this.properties = properties;
    }

    @Bean
    @Order(1)  // 最高优先级，确保在主项目的 Security 配置之前执行
    public SecurityFilterChain viewerSecurityFilterChain(HttpSecurity http) throws Exception {
